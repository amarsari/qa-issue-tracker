  ...
  app.route('/api/issues/:project')
    ...
    .get(async (req, res) => {
      ...
      try{
        ...
        res.json({ error: 'could not get issues', _id: _id });
      }
    })
    ...
    .post(async (req, res) => {
      ...
      try{
        ...
        return res.json({ error: 'could not post', _id: _id });
      }
    })
    
    .put(async (req, res) => { //this is to update a record in the db
      let projectName = req.params.project;
      const { 
        _id,
        issue_title,
    ...
    .delete(async (req, res) => {
      ...
      try {
        ...
        req.json({ result: 'successfully deleted', _id: _id });
      } catch(err) {
